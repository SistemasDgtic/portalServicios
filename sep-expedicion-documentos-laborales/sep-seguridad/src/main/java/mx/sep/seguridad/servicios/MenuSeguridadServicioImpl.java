...
public class MenuSeguridadServicioImpl implements MenuSeguridadServicio {
	...
	public OpcionMenu consultarOpcionSubOpciones(Long idPadre) {
        ...
        public OpcionMenu consultarOpcionSubOpcionesGranted(Long idPadre, String userName) {
		return opcionMenuDao.consultarOpcionSubOpcionesGranted(idPadre, userName);
	}
