 ...
 */
package test.mx.sep.expedicion.servicios;
...
//@ContextConfiguration("classpath:/mx/sep/siniestros/servicios/config/application-context-test.xml")
@ContextConfiguration( locations = { "classpath:/mx/sep/expedicion/datos/datos-mybatis-config.xml", "classpath:/mx/sep/expedicion/servicios/config/servicios-config.xml", "classpath:mx/sep/seguridad/seguridad-config.xml" })
