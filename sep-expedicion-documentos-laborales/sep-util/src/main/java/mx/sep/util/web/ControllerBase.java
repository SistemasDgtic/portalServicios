...
import static mx.sep.util.servicios.Constants.PAGE_SIZE_GRID;
import mx.sep.util.servicios.LoggerUtil;
import org.springframework.util.StringUtils;

/**
 * Los controllers pueden heredar de esta clase para hacer uso de utilerÃ­as y helpers.
 * 
...
public abstract class ControllerBase {
	...
	/**
	 * MÃ©todo de utilerÃ­a para simplificar el uso de operaciones REST como paginaciÃ³n y ordenamiento.
	 * 
	 * @param rango cadena con informaciÃ³n de la paginaciÃ³n en la forma items=x-y
	 * @param total
	 * @param request
	 * @param response
	 * @return
