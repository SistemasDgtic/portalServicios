<%-- 
    ...
    Created on : 11/05/2018, 12:43:09 AM
    ...
    <table class="pageTable" width="100%">
        <tr>
            <td colspan="2" align="center" class="tituloFondoGris">
                REPORTE DE PERCEPCIONES Y RETENCIONES DE IMPUESTO SOBRE LA RENTA</td>
        </tr>
        <tr>
            <td colspan="2" align="center" class="tituloFondoGris">
        ...
        <tr>
            <td align="center" colspan="2">
                <input id="btnImprimirResumen{aleatorio}" />
                <input id="btnCancelarResumen{aleatorio}" />
            </td>
        </tr>
    </table>
</form>
