    ...
    "dojo/dom",
        ...
        function(Form,
            ...
            function initBotones() {
                ...
                }, 'btnCancelarReporteAnualIngresos' + aleatorio);
                ...
                }, 'btnImprimirReporteAnualIngresos' + aleatorio);
            }
            ...
            function send(username, anio) {
                ...
                var proper = {
                    ...
                    method: 'GET',
                    action: configModule.urlBase + 'jasper/repReporteAnualIng',
                ...
                var pollDownload = setInterval(function() {
                    if (document.cookie.indexOf("downloadReporteAnual=" + tokenVar) > -1) {
                        document.cookie = "downloadReporteAnual=" + tokenVar + "; expires=" + new Date(0).toGMTString() + "; path=/";
