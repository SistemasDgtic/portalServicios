...
function(
	...
	Deferred
		...
		items.push( { icon: 'iconMenu', opcion: '|41|' } );
		...
		items.push( { icon: 'iconAccount', opcion: '|31|' } );
		items.push( { icon: 'iconReport', opcion: '|11|21|' } );
		items.push( { icon: 'iconFind', opcion: '|32|33|34|35|' } );
