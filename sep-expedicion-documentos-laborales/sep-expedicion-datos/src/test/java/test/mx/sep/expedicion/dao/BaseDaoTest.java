package test.mx.sep.expedicion.dao;
 ...
 * - Despu�s el archivo que contiene la configuración de spring para iniciar el contendor y sus beans.
...
@ContextConfiguration("classpath:/mx/sep/expedicion/datos/datos-mybatis-config.xml")
